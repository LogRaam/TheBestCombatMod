...
{
   [TestFixture]
   internal class ShouldersKnockedDownProbabilityTest
   {
      [Test]
      public void ItShouldReturnLowValue_WhenHitByBluntSwing()
      {
         //Given
         ...
         var sut = new ShouldersKnockedDownProbability();
      ...
      [Test]
      public void ItShouldReturnLowValue_WhenHitByCutThrust()
      {
         //Given
         var loadedOptions = Runtime.LoadedOptions.GetContent();
      ...
      [Test]
      public void ItShouldReturnLowValue_WhenHitByPierceThrust()
      {
         //Given
         var loadedOptions = Runtime.LoadedOptions.GetContent();
      ...
      [Test]
      public void ItShouldReturnModerateValue_WhenHitByBluntThrust()
      {
         //Given
         var loadedOptions = Runtime.LoadedOptions.GetContent();
         var damageType = DamageTypes.Blunt;
