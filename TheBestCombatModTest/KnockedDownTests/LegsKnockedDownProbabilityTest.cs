...
{
   [TestFixture]
   internal class LegsKnockedDownProbabilityTest
   {
      [Test]
      public void ItShouldReturnLowValue_WhenHitByCutSwing()
      {
         //Given
         ...
         var sut = new LegsKnockedDownProbability();
      ...
      [Test]
      public void ItShouldReturnModerateValue_WhenHitByPierceThrust()
      {
         //Given
         var loadedOptions = Runtime.LoadedOptions.GetContent();
         var damageType = DamageTypes.Pierce;
      ...
      [Test]
      public void ItShouldReturnStrongValue_WhenHitByBluntthrust()
      {
         //Given
         var loadedOptions = Runtime.LoadedOptions.GetContent();
         var damageType = DamageTypes.Blunt;
